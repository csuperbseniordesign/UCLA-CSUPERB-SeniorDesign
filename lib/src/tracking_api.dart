...
class TrackingApi {
  ...
  */
  ...
  Future<void> setEnableSdk({required bool enable}) async =>
  ...
  Future<void> setDisableWithUpload() =>
      _channel.invokeMethod('setDisableWithUpload');
  ...
  Future<bool?> isDisableTracking() =>
      _channel.invokeMethod('isDisableTracking');
